...
project = u'sortasurvey'
copyright = u'2021, Ashley Chontos'
author = u'Ashley Chontos'

# The short X.Y version.
version = '.'.join(sortasurvey.__version__.split('.')[1:])
# The full version, including alpha/beta/rc tags
release = sortasurvey.__version__
